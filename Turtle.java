...
public class Turtle implements Runnable, ActionListener, MouseListener, MouseMotionListener, KeyListener, ComponentListener, MouseWheelListener
{
    ...
    {
        Turtle cake = new Turtle();
        cake.up() ;
        cake.setPosition(-100,-90);
        cake.down();
        cake.penColor("red") ;
        cake.forward(190);
        cake.left(90);
        ...
        cake.forward(55);
        cake.left(90);
        cake.setPosition(-100,-35);
        cake.forward(30);
        cake.left(90);
        cake.penColor("deeppink") ;
        cake.forward(45);
        cake.right(90);
        cake.forward(130);
        cake.right(90);
        ...
        cake.left(90);
        for (int i = 0; i < 360; i++) {
            cake.forward((i % 180 < 90 || i % 180 > 270) ? 0.25:0.1);
            cake.left(1);
        }
        cake.right(90);
        cake.forward(3);
        ...
        // Sin line in red box
        cake.up();
        cake.setPosition(-100, -65);
        cake.penColor("hotpink");
        cake.down();
        for (int x = -100; x <= 90; x++) {
            int y = (int)(10 * Math.sin((x + 100) * 0.1) - 65);
            cake.setPosition(x, y);
        }
        cake.up();
        cake.setPosition(-120, -120);
